...
Default: `1password`, `chromium`, `claude-code`, `discord`, `dms`, `docker`, `element`, `fingerprint`, `flatpak`, `gdm`, `ghostty`, `git`, `hibernate`, `neovim`, `niri`, `node`, `obsidian`, `proton-mail`, `signal`, `slack`, `spotify`, `ssh`, `steam`, `syncthing`, `tailscale`

Optional: `audio`, `calibre`, `flatseal`, `github`, `golang`, `lazygit`, `printing`, `pyenv`, `rust`, `scaleway`, `scripts`, `terraform`, `tmux`, `tracker`, `vscode`, `yazi`, `zathura`
