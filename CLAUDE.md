...
Default: `1password`, `chromium`, `claude-code`, `discord`, `dms`, `docker`, `fingerprint`, `flatpak`, `fnm`, `gdm`, `ghostty`, `git`, `neovim`, `niri`, `obsidian`, `signal`, `slack`, `spotify`, `ssh`, `steam`, `syncthing`, `tailscale`
