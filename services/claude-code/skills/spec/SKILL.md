...
1. Dispatch one Explore subagent per repo this touches to find existing functions, helpers,
   and patterns to reuse or extend. It returns file:line refs only. Don't read the codebase
   into this conversation yourself.
