...
name: spark
description: >
  Challenge yourself to identify the single highest-leverage addition to the
  current plan or project. Use when you want a creative, high-impact suggestion.
invocation: /spark
---
...
- If a plan exists but implementation hasn't started yet (no commits toward the plan, no code written for it), frame your suggestion as an addition to **the plan**.
- If development is already underway (code has been written, commits made, features partially built), frame your suggestion as an addition to **the project**.
